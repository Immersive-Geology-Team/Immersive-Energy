...
public class ClientProxy extends CommonProxy {
    ...
    public static void registerModels(ModelRegistryEvent evt) {
        ...
        for (Block block : IEnContent.registeredIEnBlocks) {
            ...
            if (loc != null) {
                ...
                } else if (block instanceof BlockIEnFluid)
                    mapFluidState(block, ((BlockIEnFluid) block).getFluid());
                else
    ...
    static class FluidStateMapper extends StateMapperBase implements ItemMeshDefinition {
        ...
        public FluidStateMapper(Fluid fluid) {
            this.location = new ModelResourceLocation(ImmersiveEnergy.MODID + ":fluid_block", fluid.getName());
        }
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (tile instanceof IGuiTile) {
            ...
            if (ID == IEnGUIList.GUI_GAS_BURNER && tile instanceof TileEntityGasBurner)
                ...
                gui = new GUIFluidBattery(player.inventory, (TileEntityFluidBattery) tile);
