...
public abstract class BlockIEnTileProvider<E extends Enum<E> & BlockIEnBase.IBlockEnum> extends BlockIEnBase<E> implements IColouredBlock
{
	private boolean hasColours = false;

	public BlockIEnTileProvider(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockIEnBase> itemBlock, Object... additionalProperties)
	{
	...
	public BlockIEnTileProvider setHasColours()
	{
