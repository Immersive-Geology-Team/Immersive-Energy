...
/**
 * Created by Pabilo8 on 29-05-2020.
 */
public abstract class BlockIEnMultiblock<E extends Enum<E> & BlockIEnBase.IBlockEnum> extends BlockIEnTileProvider<E>
{
	...
	public BlockIEnMultiblock(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockIEnBase> itemBlock, Object... additionalProperties)
	{
