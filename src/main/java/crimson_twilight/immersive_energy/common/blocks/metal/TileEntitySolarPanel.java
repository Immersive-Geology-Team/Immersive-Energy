...
public class TileEntitySolarPanel extends TileEntityImmersiveConnectable implements IDirectionalTile, ITickable, IIEInternalFluxHandler, ITileDrop, IIEInternalFluxConnector
{
	...
	{
		if(facing == EnumFacing.DOWN || facing == EnumFacing.UP) { facing = EnumFacing.NORTH; }
		return facing;
	}
	@Override
	...
	public void update() 
	{
		...
		if(world.isDaytime() && world.canBlockSeeSky(getPos()))
		{
            ...
            if (!world.isRemote)
    		{
            	...
            	} else { energyStorage.modifyEnergyStored((int) (energyGeneration*modifier)); }
