...
public class BlockIEnBase<E extends Enum<E> & BlockIEnBase.IBlockEnum> extends Block implements IIEMetaBlock
{
	...
	public BlockIEnBase(String name, Material material, PropertyEnum<E> mainProperty, Class<? extends ItemBlockIEnBase> itemBlock, Object... additionalProperties)
	{
		...
		try{
			IEnContent.registeredIEnItems.add(itemBlock.getConstructor(Block.class).newInstance(this));
	...
	public BlockIEnBase setMetaHidden(int... meta)
	{
		for(int i : meta)
	...
	public BlockIEnBase setMetaUnhidden(int... meta)
	{
		for(int i : meta)
			if(i>=0 && i<this.isMetaHidden.length)
	...
	public BlockIEnBase setHasFlavour(int... meta)
	{
	...
	public BlockIEnBase<E> setBlockLayer(BlockRenderLayer... layer)
	{
		this.renderLayers = Sets.newHashSet(layer);
		return this;
	}
	public BlockIEnBase<E> setMetaBlockLayer(int meta, BlockRenderLayer... layer)
	{
	...
	public BlockIEnBase<E> setMetaLightOpacity(int meta, int opacity)
	{
	...
	public BlockIEnBase<E> setMetaExplosionResistance(int meta, int resistance)
	{
	...
	public BlockIEnBase<E> setNotNormalBlock(int meta)
	{
	...
	public BlockIEnBase<E> setAllNotNormalBlock()
	{
		if(metaNotNormalBlock == null)
			metaNotNormalBlock = new boolean[this.enumValues.length];
	...
	public BlockIEnBase<E> setOpaque(boolean isOpaque)
	{
		opaqueCube = isOpaque;
		fullBlock = isOpaque;
		return this;
	...
	{
		return ImmersiveEnergy.MODID+":"+name;
	}
	...
	public abstract static class IPLadderBlock<E extends Enum<E> & IBlockEnum> extends BlockIEnBase<E>
	{
		public IPLadderBlock(String name, Material material, PropertyEnum<E> mainProperty,
							 Class<? extends ItemBlockIEnBase> itemBlock, Object... additionalProperties)
		{
