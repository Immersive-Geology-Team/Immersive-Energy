package com.igteam.immersiveenergy.client.helper;
...
public class IENRecipeBuilder<R extends IENRecipeBuilder<R>> implements FinishedRecipe {
    ...
    protected IENRecipeBuilder(RecipeSerializer<?> serializer) {
    ...
    public IENRecipeBuilder<R> addWriter(Consumer<JsonObject> writer) {
        Preconditions.checkArgument(this.id == null, "This recipe has already been finalized");
        this.writerFunctions.add(writer);
        return this;
    }

    public IENRecipeBuilder<R> addCondition(ICondition condition) {
    ...
    public IENRecipeBuilder<R> setTime(int time) {
        return this.addWriter((jsonObject) -> {
            jsonObject.addProperty("time", time);
        });
    }

    public IENRecipeBuilder<R> setEnergy(int energy) {
        return this.addWriter((jsonObject) -> {
            jsonObject.addProperty("energy", energy);
        });
    }

    public IENRecipeBuilder<R> setMultipleResults(int maxResultCount) {
    ...
    public IENRecipeBuilder<R> addMultiResult(JsonElement obj) {
    ...
    public IENRecipeBuilder<R> addResult(ItemLike itemProvider) {
        return this.addResult(new ItemStack(itemProvider));
    }

    public IENRecipeBuilder<R> addResult(ItemStack itemStack) {
        return this.resultArray != null ? this.addMultiResult(this.serializeItemStack(itemStack)) : this.addItem("result", itemStack);
    }

    public IENRecipeBuilder<R> addResult(Ingredient ingredient) {
    ...
    public IENRecipeBuilder<R> addResult(IngredientWithSize ingredientWithSize) {
    ...
    public IENRecipeBuilder<R> setUseInputArray(int maxInputCount, String key) {
    ...
    public IENRecipeBuilder<R> setUseInputArray(int maxInputCount) {
        return this.setUseInputArray(maxInputCount, "inputs");
    }

    public IENRecipeBuilder<R> addMultiInput(JsonElement obj) {
    ...
    public IENRecipeBuilder<R> addMultiInput(Ingredient ingredient) {
        return this.addMultiInput(ingredient.toJson());
    }

    public IENRecipeBuilder<R> addMultiInput(IngredientWithSize ingredient) {
    ...
    public IENRecipeBuilder<R> addInput(ItemLike... itemProviders) {
    ...
    public IENRecipeBuilder<R> addInput(ItemStack... itemStacks) {
    ...
    protected IENRecipeBuilder<R> addSimpleItem(String key, ItemLike item) {
        return this.addWriter((json) -> {
            json.addProperty(key, BuiltInRegistries.ITEM.getKey(item.asItem()).toString());
        });
    }

    public IENRecipeBuilder<R> addItem(String key, ItemLike item) {
        return this.addItem(key, new ItemStack(item));
    }

    public IENRecipeBuilder<R> addItem(String key, ItemStack stack) {
    ...
    public IENRecipeBuilder<R> addIngredient(String key, ItemLike... itemProviders) {
        return this.addIngredient(key, Ingredient.of(itemProviders));
    }

    public IENRecipeBuilder<R> addIngredient(String key, ItemStack... itemStacks) {
        return this.addIngredient(key, Ingredient.of(itemStacks));
    }

    public IENRecipeBuilder<R> addIngredient(String key, TagKey<Item> tag) {
        return this.addIngredient(key, Ingredient.of(tag));
    }

    public IENRecipeBuilder<R> addIngredient(String key, Ingredient ingredient) {
        return this.addWriter((jsonObject) -> {
            jsonObject.add(key, ingredient.toJson());
        });
    }

    public IENRecipeBuilder<R> addIngredient(String key, IngredientWithSize ingredient) {
        return this.addWriter((jsonObject) -> {
            jsonObject.add(key, ingredient.serialize());
        });
    }

    public IENRecipeBuilder<R> addFluid(String key, FluidStack fluidStack) {
        return this.addWriter((jsonObject) -> {
            jsonObject.add(key, ApiUtils.jsonSerializeFluidStack(fluidStack));
        });
    }

    public IENRecipeBuilder<R> addFluid(FluidStack fluidStack) {
        return this.addFluid("fluid", fluidStack);
    }

    public IENRecipeBuilder<R> addFluid(Fluid fluid, int amount) {
        return this.addFluid("fluid", new FluidStack(fluid, amount));
    }

    public IENRecipeBuilder<R> addFluidTag(String key, FluidTagInput fluidTag) {
        return this.addWriter((jsonObject) -> {
            jsonObject.add(key, fluidTag.serialize());
        });
    }

    public IENRecipeBuilder<R> addFluidTag(String key, TagKey<Fluid> fluidTag, int amount) {
        return this.addFluidTag(key, new FluidTagInput(fluidTag, amount, (CompoundTag)null));
    }

    public IENRecipeBuilder<R> addFluidTag(TagKey<Fluid> fluidTag, int amount) {
