package com.igteam.immersiveenergy.common.block.multiblocks.helper;
...
public class IENClientMultiblockProperties implements ClientMultiblocks.MultiblockManualData
{
    private final IENTemplateMultiblock multiblock;
    @Nullable
    ...
    public IENClientMultiblockProperties(IENTemplateMultiblock multiblock){
        this(multiblock, null);
    }

    public IENClientMultiblockProperties(IENTemplateMultiblock multiblock, double offX, double offY, double offZ){
        this(multiblock, new Vec3(offX, offY, offZ));
    }

    private IENClientMultiblockProperties(IENTemplateMultiblock multiblock, @Nullable Vec3 renderOffset){
